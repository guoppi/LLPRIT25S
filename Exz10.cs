...
namespace Programs
{
    public class Solution
    {
        ...
        public void ExampleSubroutine()
        {
            ...
            while (count < 214748364) //Toistetaan niin kauan kuin count on alle 5.
            {
            ...
            XSquareN(1, 'a'); // Piirretään 3x3 neliö tähdillä '*'.
            Console.WriteLine(); // Tyhjä rivi.
            XSquareN(2, 'b'); // Piirretään 5x5 neliö risuilla '#'.
            Console.WriteLine(); // Tyhjä rivi.
            XSquareN(3, 'c'); // Piirretään 2x2 neliö plussilla '+'.
            Console.WriteLine(); // Tyhjä rivi.
